...
namespace Trees
{
    public class TreeMapComparer1 : IComparer<int>
    {
    ...
    public class Tree
    {
        ...
        TreeMapComparer1 comparator = new TreeMapComparer1();
        public Entry<int, int> x;
        public int dx = 0;
        public Tree left;
        public Tree right;

        public Tree(Entry<int, int> xx, int dxx,int s)
        {
            x = xx;
            dx = dxx;
            node_size = s;
        }
        public void Add(Entry<int,int> xx)
        {
            if (comparator.Compare(xx.key, x.key) != 1)
            {
                if (left == null)
                {
